...
const EmpEdit = () => {
  ...
  useEffect(()=>{
    axios.get(`http://localhost:1500/employee/${id}`)//fetch
    .then((res)=>{
  ...
  function Update(e) {
    e.preventDefault();
    axios.put(`http://localhost:1500/employee/${id}`,data).then(navigate("/admin/emp-list"));//post
  }
        ...
        <div className="editEmp_form">
            ...
            <form action="">
               <div className="name">
                ...
                <button className="but_dept" type="submit" onClick={Update}>UPDATE</button>
